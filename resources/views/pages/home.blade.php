                        ...
                        <a href="{{ route('kos.show', $popularBoardingHouse->slug) }}" class="card">
                            <div
                                ...
                                <div class="flex w-full h-[150px] shrink-0 rounded-[30px] bg-[#D9D9D9] overflow-hidden">
                                    <img src="{{ asset('storage/'.$popularBoardingHouse->thumbnail) }}" class="w-full h-full object-cover"
                                        alt="thumbnail">
                                </div>
                                <div class="flex flex-col gap-3">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        <img src="assets/images/icons/profile-2user.svg" class="w-5 h-5 flex shrink-0"
                                            alt="icon">
                                        <p class="text-sm text-ngekos-grey">{{ $popularBoardingHouse->capacity ?? '-' }}</p>
                                    </div>
                                    <hr class="border-[#F1F2F6]">
                                    <p class="font-semibold text-lg text-ngekos-orange">Rp {{ number_format($popularBoardingHouse->price, 0,',','.') }}<span
                        ...
                        <div
                            ...
                            <div class="flex flex-col gap-3 w-full">
                                ...
                                <div class="flex items-center gap-[6px]">
                                    <img src="assets/images/icons/profile-2user.svg" class="w-5 h-5 flex shrink-0"
                                        alt="icon">
                                    <p class="text-sm text-ngekos-grey">{{ $boardingHouse->capacity }}</p>
                                </div>
                                <hr class="border-[#F1F2F6]">
